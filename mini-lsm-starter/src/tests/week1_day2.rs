...
fn test_task2_merge_3() {
    let i1 = MockIterator::new(vec![
        (Bytes::from("1"), Bytes::from("1.1")),
        (Bytes::from("3"), Bytes::from("3.1")),
    ]);
    let i2 = MockIterator::new(vec![
        (Bytes::from("1"), Bytes::new()),
        (Bytes::from("2"), Bytes::new()),
        (Bytes::from("3"), Bytes::from("3.2")),
        (Bytes::from("4"), Bytes::from("4.2")),
    ]);
    let i3 = MockIterator::new(vec![
        (Bytes::from("1"), Bytes::from("1.3")),
        (Bytes::from("2"), Bytes::from("2.3")),
        (Bytes::from("3"), Bytes::from("3.3")),
    ]);
